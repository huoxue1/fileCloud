...
func Router() *gin.Engine {
	...
	engine.POST("/check_file", controller.CheckFile())

	engine.POST("/mkdir", controller.Mkdir())
	engine.DELETE("/delete_file", controller.DeleteFile())

	engine.GET("/download", controller.DownloadFile())
